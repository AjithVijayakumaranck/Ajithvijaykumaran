...
const Experience = () => {
  return (
    <div className='text-black  py-10 md:rounded-[100px] relative overflow-hidden'>
      <img src={gray} alt="" className='absolute top-32 max-md:hidden animate-spin-reverse' />
        <div className='flex flex-col items-center  pb-24  text-secondary relative '>
          ...
          <div className='hover:scale-110 transition-all duration-300  flex flex-col md:items-end items-center gap-4 px-10  min-w-[500px]  bg-primaryOrange text-white  rounded-lg py-10'>
            ...
            <div className='hover:scale-110 transition-all duration-300  flex flex-col items-center md:items-start  min-w-[500px] px-10  gap-4   bg-primary text-secondary  rounded-lg py-10'>
        ...
        <div className='hover:scale-110 transition-all duration-300 flex justify-center items-center gap-10 w-full flex-wrap max-md:px-10'>
        <div className=' flex flex-col items-center gap-4 w-full bg-secondary text-white px-24 rounded-lg py-10'>
