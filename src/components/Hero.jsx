...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      />
      {/* <div className="heroContainer relative bg-white flex flex-col border-white border-[5px] justify-center items-center aspect-square md:h-60 rounded-full text-white">
